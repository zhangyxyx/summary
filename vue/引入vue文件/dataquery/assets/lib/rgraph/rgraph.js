(function webpackUniversalModuleDefinition(root, factory) {
    ...
    /******/([
        ...
        /***/ function (module, exports, __webpack_require__) {
            !function t(e, r) {
                true ? module.exports = r() : "function" == typeof define && define.amd ? define("Raphael", [], r) : "object" == typeof exports ? exports.Raphael = r() : e.Raphael = r()
            }(this, function () {
                return function (t) {
                    function e(i) {
            ...
            !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
                ...
                function _getLoading(width, height) {
                    ...
                    var styles = ["position:absolute",
                        ...
                        "left:0",
                        "zIndex:9999",
                        "background:none",         //wc修改。原来是rgba(0,0,0,0.6)
                        "text-align:center",
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
                ...
                Paper.prototype.init = function () {
                    var _optdrag = this.graph.option.drag;
                    ...
                    RDom.addEventListener(this.graph.dom.querySelector('svg'), 'mousedown', function (e) {
                        if(_optdrag == false) return false
                ...
                Paper.prototype.mousedownfn = function (e) {
                    ...
                    if (evt.target.parentNode == this.graph.dom) {
                        ...
                        this.graph.dom.style.cursor = 'pointer';
                    }
                };
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
                ...
                Node.prototype._add = function (id, option) {
                        ...
                        case 'image':
                            ...
                            if (_text) {
                                ...
                                if ('bottom' == _textAlign) {
                                    ...
                                    _node.rText.attr({
                                        x: _x + Math.cos(_angle) * 100,
                                        y: _y + Math.sin(_angle) * 100
                                    }).rotate(tAngle);
                                }
                            }
                            // if(_circleAttr){
                            //     var r = Math.max(_width,_height)/2;
                            //     _node.raphAlarm = _node.graph.rPaper.circle(_x+_width/2,_y+_height/2,r).attr(_circleAttr).toBack();
                            // }
                            break;
                        case 'ellipse':
                    ...
                    // rightclick begin
                    if (option.rightMenu) {
                        if(option.rightFlag != "node"){
                            _node.rNode.mousedown(function (e) {
                            e = e || window.event;
                            if (e.button != 2) {
                                return;
                            }
                              if( 'function'===typeof option.rightMenu){
                                  option.rightMenu(_node.id, _text);
                                  var _rightInfo=Global.rightMenu;
                                  RightMenu.create(_node.id, _text, _rightInfo);
                              }else{
                    ...
                    var _draggable = option.draggable;
                        ...
                        _node.rNode.drag(function (dx, dy, x, y, event) {
                            ...
                            // if(_node.raphAlarm){
                            //     _node.raphAlarm.transform(["t",_tx+dx/_node._zoom,_node._ty+dy/_node._zoom].join(","));
                            // }
                            if (_node.extends) {
                ...
                Node.prototype.weaken = function () {
                    ...
                    // if (_node.raphAlarm) {
                    //     oldOpacity = _node.raphAlarm.attr('opacity');
                    //     _node.raphAlarm.oldOpacity = oldOpacity;
                    //     _node.raphAlarm.attr('opacity', oldOpacity * 0.1);
                    // }
                };
                Node.prototype.restore = function () {
                    ...
                    // if (_node.raphAlarm) {
                    //     _node.raphAlarm.attr('opacity', _node.raphAlarm.oldOpacity);
                    // }
                };
                return Node;
            }.call(exports, __webpack_require__, exports, module), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            !(__WEBPACK_AMD_DEFINE_RESULT__ = function () {
                ...
                function create(id, name, menus) {
                    ...
                    var liStyles = ['border-left:1px solid #fff', 'font-size:12px', 'color:#333', 'margin:3px 3px 3px 15px', 'padding:2px 20px 2px 2px', 'font-weight:bold', 'cursor:pointer'];
                    for (var i = 0, len = menus.length; i < len; i++) {
                        ...
                        li.setAttribute('data-action',menus[i].innerhtml);
                        if ('function' == typeof menus[i].func) {
                            (function (callback) {
                                li.onclick = function () {
                                    callback(id, name,this.getAttribute('data-action'));
                                };
                            })(menus[i].func);
                        }
