$(function(){
    ...
    // var a1 = '240E:37C:8F0::/50'
    // var a2 = '240E:37C:8F0::/44'
    // var addr1 = ipv6AddrFormatStartEnd(a1,'start')
    // var addr2 = ipv6AddrFormatStartEnd(a1,'end')
    // var addr3 = ipv6AddrFormatStartEnd(a2,'start')
    // var addr4 = ipv6AddrFormatStartEnd(a2,'end')
    // console.log(a1)
    // console.log(a2)
    // console.log(addr1)
    // console.log(addr2)
    // console.log(addr3)
    // console.log(addr4)
    // console.log(ipv6AddrInFree(addr1,addr2,addr3,addr4))
...
function initSubmitBtnClickEvent(){
    $("#submitBtn").click(function(){
        ...
        var PlanAddrList = [];
        // console.log($("#ipTypeList").combobox('getValue'))
        for(var i = 0;i < ipv6TableList.length;i ++){
            PlanAddrList.push({
                addInetNum:ipv6TableList[i].addInetNum,
                oriNodeCode:topNodeCode,
                planNodeCode:$("#nodeList").combobox('getValue'),
                oriIpType:OriIpType,
                planIpType:$("#ipTypeList").combobox('getValue'),
                remark:ipv6TableList[i].Remark
            })
        }
        let params = {
        ...
        $.ajax({
            url:encodeURI(bathPath+'/ipaddrmodule/Ipv6/PlanAddrAddV6'),
            type:'POST',
            ...
            success:function(obj){
                if(obj.code == "0000"){
                    $.messager.alert('提示','地址新增成功！','success');
                    window.parent.getSearcLeftNode('all')
                }else{
...
function loadIpv6InfoTable(ipv6Len){
    /*定义表格的表头*/
    var columnsData=[[
        {field:'nodeName', title: '规划组织',align:'center',width:100},
