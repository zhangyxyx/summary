...
function importPlanAddrInfo() {
    ...
    content += '</form>'
    content += '<div id="insertinfo" style="margin-top:20px; display:none; font-size:12px; color:#f00;">计划导入数：<span id="totalNum">--</span>条，成功导入：<span id="succesNum">--</span>条，失败:<span id="errorNum">xx</span><span id="erroridspan">条，失败明细如下：</span></div>'
