  ...
  $(".importBtn").click(function () {
      if ($(this).val() == "导入") {
          ...
          $("#importForm").ajaxSubmit({
              url: encodeURI(bathPath + '/ipaddrmodule/IpBatchQuery/QueryIpv6Batch'),
          ...
          elink.href = bathPath+"/"+'ipaddrmodule/itep/var/config/ipaddr/ipv6BathQueryTemp.csv';
...
function getPlanAddrDetail(pageSize,pageNum) {
  ...
  $.ajax({
    ...
    // url: encodeURI('/ipaddrmodule/IpBatchQuery/GetIpBatchQueryList'),
    type: 'post',
