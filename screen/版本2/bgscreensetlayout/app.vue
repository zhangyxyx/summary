  ...
  <div class="app-container">
    <el-row>
      <el-col :span="24" style="text-align:right">
         <el-button type="primary" size="small" @click="showframe" class="el-button filter-item el-button--primary el-button--mini">显示布局(先设置后展示)</el-button>
      </el-col>
    </el-row>
    <Main/>
...
export default {
  ...
  methods:{
    showframe(){
      window.open('/views/setscreen/bgscreenshow.html')
    },
    exportjson(){
        var screendata=this.$.cookie('screendata');
        var data = screendata
